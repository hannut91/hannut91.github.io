...
- 실습으로 마스터하는 OAuth 2.0: 기본부터 보안 위험까지 강의 제작
- 자바스크립트로 직접 만들면서 배우는 자료구조와 알고리즘 강의 제작
...
<div class="title-with-date">
  <h4><strong>VimEnter 2023 모임 발표 - Vim 힘들고 빠르게 배우는 방법</strong></h4>
  <h4>2023.12.23</h4>
</div>
...
<div class="title-with-date">
  <h4><strong>인프콘 2023 - 안타깝게도 오늘의 TDD는 실패한 것 같군요. 내일은 가능할지도...? 발표</strong></h4>
  <h4>2023.08.15</h4>
</div>

<div class="title-with-date">
  <h4><strong>인프콘 2022 - 성공하는 스터디를 만드는 10가지 방법 - 인출 위주의 스터디 여정기 발표</strong></h4>
  <h4>2022.08.26</h4>
</div>

<div class="title-with-date">
  <h4><strong>GDG Korea WebTech Online Lightning Talk 발표</strong></h4>
  <h4>2020.05.16</h4>
</div>
